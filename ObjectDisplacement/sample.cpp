...
float	RotVal;					// how much to rotate blades
...
Display( )
{
	...
	if (ViewSpot == 0)
	{
		gluLookAt(10.f, 7.f, -10.f, 0.f, 0.f, -1.5f, 0.f, 1.f, 0.f);
	...
	{
		gluLookAt(-0.4, 1.8, -4.9, -0.4, 1.8, -10., 0.f, 1.f, 0.f);
	}
