...
// textures
GLuint	SphereDL, VenusDL, EarthDL, MoonDL, JupiterDL, SaturnDL, UranusDL, NeptuneDL, PlutoDL, ToggleDL;
GLuint	VenusTex, EarthTex, MoonTex, JupiterTex, SaturnTex, UranusTex, NeptuneTex, PlutoTex, ToggleTex;
bool	LightingOn;
bool	TextureOn;
...
Display( )
{
	...
	// checks for texture and lighting:
	...
	if (LightingOn) {
		...
		glEnable(GL_LIGHT0);
		SetPointLight(GL_LIGHT0, 15 * cos(12.566 * Time), 0., 15 * sin(12.566 * Time), 5., 5., 5.);
